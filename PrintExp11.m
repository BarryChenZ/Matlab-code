%11. Contact rate不同的影響 → 改變
iter_time = 50;
x = [0:1:iter_time-1];

f1 = fopen('Result data\\exp11\\SimRes_exp11_1.csv');
f2 = fopen('Result data\\exp11\\SimRes_exp11_2.csv');
f3 = fopen('Result data\\exp11\\SimRes_exp11_3.csv');
f4 = fopen('Result data\\exp11\\AnaRes_exp11_1.csv');
f5 = fopen('Result data\\exp11\\AnaRes_exp11_2.csv');
f6 = fopen('Result data\\exp11\\AnaRes_exp11_3.csv');
...
legend('Ana R_c = 0.3 ','Ana R_c = 0.6','Ana R_c = 0.9'); % 圖形註解   