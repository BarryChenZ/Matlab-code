%3. Collision cost 不同的影響 → I改變
iter_time = 50;
x = [0:1:iter_time-1];

f1 = fopen('Result data\\exp4\\SimRes_exp4_1.csv');
f2 = fopen('Result data\\exp4\\SimRes_exp4_2.csv');
f3 = fopen('Result data\\exp4\\SimRes_exp4_3.csv');
f4 = fopen('Result data\\exp4\\AnaRes_exp4_1.csv');
f5 = fopen('Result data\\exp4\\AnaRes_exp4_2.csv');
f6 = fopen('Result data\\exp4\\AnaRes_exp4_3.csv');
...
xlabel('t(time)'); % x軸註解
ylabel('The fraction of I'); % y軸註解
title('Different Decline rate of SEIRD model'); % 圖形標題
legend('Sim, R_d = 0.2','Sim, R_d = 0.5','Sim, R_d = 1.0',...
       'Ana, R_d = 0.2','Ana, R_d = 0.5','Ana, R_d = 1.0'); % 圖形註解