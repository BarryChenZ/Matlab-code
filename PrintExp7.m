...
f1 = fopen('Result data\\exp7\\SimRes_exp7_1.csv');
f2 = fopen('Result data\\exp7\\SimRes_exp7_2.csv');
f3 = fopen('Result data\\exp7\\SimRes_exp7_3.csv');
f4 = fopen('Result data\\exp7\\AnaRes_exp7_1.csv');
f5 = fopen('Result data\\exp7\\AnaRes_exp7_2.csv');
f6 = fopen('Result data\\exp7\\AnaRes_exp7_3.csv');
