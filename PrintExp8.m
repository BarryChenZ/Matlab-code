...
f1 = fopen('Result data\\exp8\\SimRes_NEWexp8_1.csv');
f2 = fopen('Result data\\exp8\\SimRes_NEWexp8_2.csv');
f3 = fopen('Result data\\exp8\\SimRes_NEWexp8_3.csv');
f4 = fopen('Result data\\exp8\\AnaRes_NEWexp8_1.csv');
f5 = fopen('Result data\\exp8\\AnaRes_NEWexp8_2.csv');
f6 = fopen('Result data\\exp8\\AnaRes_NEWexp8_3.csv');
...
title('Different Range of SEIRD model'); % 圖形標題
legend(...
       'Sim E state, Rad = 10.0','Sim E state, Rad = 100.0','Sim E state, Rad = 300.0',...
       'Ana E state, Rad = 10.0','Ana E state, Rad = 100.0','Ana E state, Rad = 300.0'); % 圖形註解
...
ylabel('The fraction of I'); % y軸註解
title('Different Range of SEIRD model'); % 圖形標題
legend('Sim I state, Rad = 10.0','Sim I state, Rad = 100.0','Sim I state, Rad = 300.0',...
       'Ana I state, Rad = 10.0','Ana I state, Rad = 100.0','Ana I state, Rad = 300.0'); % 圖形註解